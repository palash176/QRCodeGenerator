# QR Code web_application


## Getting started
Clone repository and enter back_end-main folder to start spring boot server. 
`.\mvnw.cmd clean spring-boot:run
`
Server runs QR code Generator Service and utility to gather POST/GET request from local React / mobile frontend
